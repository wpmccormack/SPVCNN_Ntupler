...
simHcalTriggerPrimitiveNtupleWithRadialCutoffEXPANDEDINFO = cms.EDProducer("HcalTrigPrimDigiNtuplerEXPANDEDINFO",
    clus_src = cms.InputTag("printTheDetIDsWithRadialCutoffEXPANDEDINFO","HBHERecHitTruth")
)

simHcalTriggerPrimitiveNtupleRecoWithRadialCutoffEXPANDEDINFO = cms.EDProducer("HcalTrigPrimDigiNtuplerEXPANDEDINFO",
    clus_src = cms.InputTag("printTheDetIDsRecoWithRadialCutoffEXPANDEDINFO","HBHERecHitTruth")
)
